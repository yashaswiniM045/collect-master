...
const WatchedHistoryPage = () => {
  ...
  // Unique genres for the filter dropdown (bonus: filter by genre)
            ...
            <div className="movie-card" key={movie.movieId}>
              ...
              <div className="movie-card-body">
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <button className="btn btn-secondary" onClick={() => handleMoveBack(movie.movieId)}>
                    Move to Watchlist
                  </button>
                  <button className="btn btn-danger" onClick={() => handleRemove(movie.movieId)}>
                    Remove
                  </button>
                </div>
              </div>
